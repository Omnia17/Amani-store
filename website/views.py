...
def index(request):
    ...
    if len(messages) > 0 :
        for msg in messages:
            ...
            sections['data'][i]['values']['text'] = msg['values']['text'].replace('"', '')
...
def categories(request):
    ...
    template = loader.get_template('molla-1/pages/categories/index.html')
...
def wishlist(request):
    ...
    template = loader.get_template('molla-1/pages/whishlist/index.html')
...
def account(request):
    ...
    template = loader.get_template('molla-1/pages/account/index.html')
...
def contact(request):
    ...
    template = loader.get_template('molla-1/pages/contact/index.html')
...
def reset_pass(request):
    ...
    template = loader.get_template('molla-1/pages/reset-pass/index.html')
...
def error404(request, exception):
    ...
    template = loader.get_template('molla-1/pages/errors/404.html')
...
def error500(request):
    ...
    template = loader.get_template('molla-1/pages/errors/500.html')
